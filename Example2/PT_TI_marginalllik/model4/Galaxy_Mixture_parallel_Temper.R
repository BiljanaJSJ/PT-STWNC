...
for (l in (1:niter)){  
  ...
  pn_1[l,i] = posterior(y,means=out_ls$means[[i-1]][,l],Sigma=sigma2_kl,p=out_ls$pmatrix[[i-1]][,l],Z=out_ls$Z[[i-1]],beta=beta[i-1],k=k,Meanpriorpars=Meanpriorpars,priorpars=Sigmapriorpars,Ppriorpars=Ppriorpars)
  pn[l,i]   = posterior(y,means=out_ls$means[[i-1]][,l],Sigma=sigma2_kl,p=out_ls$pmatrix[[i-1]][,l],Z=out_ls$Z[[i-1]],beta=beta[i],k=k,Meanpriorpars=Meanpriorpars,priorpars=Sigmapriorpars,Ppriorpars=Ppriorpars)
  ...
  pns[l,i]   = posterior(y,means=out_ls$means[[i]][,l],Sigma=sigma2_kl1,p=out_ls$pmatrix[[i]][,l],Z=out_ls$Z[[i]],beta=beta[i-1],k=k,Meanpriorpars=Meanpriorpars,priorpars=Sigmapriorpars,Ppriorpars=Ppriorpars)
...
eval=list(pn_1=pn_1,pn=pn,pn_1s=pn_1,pns=pns)
